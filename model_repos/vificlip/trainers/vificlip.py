...
import sys
from model_repos.vificlip.clip import clip
from model_repos.vificlip.clip.simple_tokenizer import SimpleTokenizer as _Tokenizer
...
class VLPromptLearner(nn.Module):
    def __init__(self, cfg, classnames, clip_model, logger=None):
        super().__init__()
...
def returnCLIP(config, class_names=None,logger = None):
    print(True)
